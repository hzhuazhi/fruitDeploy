...
//            log.error(String.format("HttpGetUtil.getUrl is error!,  parame : url = %s", url));
    ...
    public static void main(String[] args)throws  Exception {
        ...
        String url1 = URLEncoder.encode("https://www.alipay.com/?appId=09999988&actionType=toCard&sourceId=bill&cardNo=6226************4107&bankAccount=孟宪宏&money=&amount=&bankMark=CEB&bankName=光大银行&cardIndex=2008281313097799810&cardNoHidden=true&cardChannel=HISTORY_CARD&orderSource=from&buyId= auto","UTF-8");
