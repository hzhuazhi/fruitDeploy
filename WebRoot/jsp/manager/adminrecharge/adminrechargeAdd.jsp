    ...
    <div class="formContentDiv">
        <form id="addSupplierForm">
            ...
            <ul>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" ><font color="red">*</font>下发的订单号：</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="issueOrderNo" name="issueOrderNo"	maxlength="240" />
                    </div>
                </li>
