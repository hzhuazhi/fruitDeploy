        ...
        <form id="addSupplierForm">
            <ul>
                ...
                <li style="border-top: none;">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="startMoney" name="startMoney" value="${dl.startMoney}"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="endMoney" name="endMoney" value="${dl.endMoney}"	maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
                    ...
                    <div class="formCtrlDiv">
                        <textarea id="smsContent" name="smsContent">${dl.smsContent}</textarea>
                    </div>
                </li>
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    url : ctx+ "/bankShortMsgStrategy/update.do",
                    type : 'post',
                    dataType : 'json',
                    data :formData,
